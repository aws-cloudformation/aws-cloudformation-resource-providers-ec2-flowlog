...
public class UpdateHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess_UpdateTags() {
        ...
        final Map<String, String> desiredReourceTags = new HashMap<String, String> (){{
            put("k2", "v2");
            put("k3", "v3");
        }};
        ...
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
            ...
            .desiredResourceTags(desiredReourceTags)
    ...
    public void handleRequest_SimpleSuccess_OnlyDeleteTags() {
        ...
        ResourceModel model = Translator.createModelFromFlowLog(TEST_FLOW_LOG_TO_S3);
        // deleting all existing tags updates the tags field to empty list instead of null
        List<software.amazon.ec2.flowlog.Tag> emptyTags = Collections.emptyList();
        model.setTags(emptyTags);
